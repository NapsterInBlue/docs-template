Ideally, the [General Contribution Guide](https://git/pages/DataScienceWiki/ContributionGuide/) covers a good chunk of what you'd want to include in a `CONTRIBUTING` message. Please feel free to reference it wherever you think it'd be useful.

Additionally, the following is a pretty exhaustive template for anything else you might want to add.
...
[Here are some documents to help walk someone through their first pull request.](https://git/pages/DataScienceWiki/ContributionGuide/firsttime.html)

And here are a couple of friendly tutorials you can include: http://makeapullrequest.com/ and http://www.firsttimersonly.com/
...
Here you should point users to the template located at /.github/ISSUE_TEMPLATE.md
